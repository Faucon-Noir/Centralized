		...
		case 1:
			return (
				<Chip
					color='success'
					size='small'
					label={urgenceIdToString(1)}
				/>
			);
		case 2:
			return (
				<Chip color='info' size='small' label={urgenceIdToString(2)} />
			);
		case 3:
			return (
				<Chip
					color='warning'
					size='small'
					label={urgenceIdToString(3)}
				/>
			);
		case 4:
			return (
				<Chip color='error' size='small' label={urgenceIdToString(4)} />
			);
		default:
		case 0:
