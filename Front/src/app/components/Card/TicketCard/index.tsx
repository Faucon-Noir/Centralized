...
export default function TicketCard({ id, title, start, end, urgence, updated_at, status, planningId, userData, description, mail, projectId }: { description: any; userData: any; id: any; title: any; start: any; end: any; urgence: Urgence; updated_at: Date; status: Status; planningId: any; mail: string, projectId: string }) {
	const [ticket, setTicket] = useState({ start_date: start, end_date: end, planningId: planningId, userId: mail, title: title, urgenceId: urgence, description: description, status: status });
					...
					<div className="ticket_main_modal">
						...
						<div className="ticket_form">
							...
							<div className="second_line">
								<div className="input_grp">
									<p>Status</p>
									<select value={ticket.status} onChange={(e) => { const newStatus = e.target.value.trim() as Status; setTicket({ ...ticket, status: newStatus }); }} required>
								...
								<div className="input_grp">
									<p>Urgence</p>
									<select value={ticket.urgenceId} onChange={(e) => { const newStatus = parseInt(e.target.value) as Urgence; setTicket({ ...ticket, urgenceId: newStatus }); }}  required>
